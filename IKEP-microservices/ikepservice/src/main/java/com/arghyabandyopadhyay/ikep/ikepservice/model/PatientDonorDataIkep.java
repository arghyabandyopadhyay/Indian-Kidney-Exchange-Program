...
public class PatientDonorDataIkep {
    ...
    public PatientDonorDataIkep(int indexVertex, PatientDonorData patientDonorData) {
        this.id = patientDonorData.getId();
        this.indexVertex = indexVertex;
        this.name = patientDonorData.getName();
        this.bloodGroup = patientDonorData.getBloodGroup();
        this.hla = patientDonorData.getHla();
        this.age = patientDonorData.getAge();
        this.kidneySize = patientDonorData.getKidneySize();
        this.pincode = patientDonorData.getPincode();
        this.nameOfDonor = patientDonorData.getNameOfDonor();
        this.bloodGroupOfDonor = patientDonorData.getBloodGroupOfDonor();
        this.hlaOfDonor = patientDonorData.getHlaOfDonor();
        this.ageOfDonor = patientDonorData.getAgeOfDonor();
        this.kidneySizeOfDonor = patientDonorData.getKidneySizeOfDonor();
        this.pincodeOfDonor = patientDonorData.getPincodeOfDonor();
        this.priority = patientDonorData.getPriority();
        this.societalPreference = patientDonorData.getSocietalPreference();
        this.societalDistributionOfDonor = patientDonorData.getSocietalDistributionOfDonor();
        this.mobileNumber=patientDonorData.getMobileNumber();
