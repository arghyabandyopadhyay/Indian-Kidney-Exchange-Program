...
public class IkepExchangeCycleGenerator {
    ...
    IkepExchangeCycleGenerator(int sPrefMax, int maxCycleLength, int edgeFilter, int ageFilter, double ageReducingCoefficient, int maxAgeScore, int maxABOScore, int maxPinScore, int maxKidneyScore, int kidneyFilter, int pincodeFilter, int pincodeReducingCoeff1, int pincodeReducingCoeff2, boolean usingSAS){
